...
insertPhrase('times_info',
             'Սրանք այն ժամանակներն են, երբ բոտը ավտոմատ կթարմացնի ձեր հայտարարությունները:',
             'В эти времена бот будет автоматически обновлять ваши объявления.',
             'These are the times the bot will automatically renew your listing.')

insertPhrase('ask_new_time',
             'Մուտքագրեք այն ժամը, երբ ցանկանում եք թարմացնել ձեր հայտարարությունները, օրինակ <code>15:00</code>',
             'Введите время, когда вы хотите обновить свои объявления, например <code>15:00</code>.',
             'Enter the time you want to renew your listings, for example <code>15:00</code>')
insertPhrase('ask_new_limit',
             'Մուտքագրեք հայտարարությունների առավելագույն քանակը,0 նշանակում է թարմացնել հասանելի ամեն ինչ, որոնք ցանկանում եք թարմացնել, օրինակ <code>50</code>',
             'Введите максимальное количество объявлений, которые вы хотите продлить,0 означает обновление всего доступного, например <code>50</code>.',
             'Enter the maximum number of listings you want to renew, 0 means renew everything available, for example <code>50</code>')
insertPhrase('time_added_successfully',
             '✅ Թարմացնելու ժամը հաջողությամբ ավելացվեց ✅',
             '✅ Время объявления успешно добавлено ✅',
             '✅ Renew time added successfully ✅')
insertPhrase('change_time',
             'Մուտքագրեք թարմացման նոր ժամ, օրինակ <code>15:00</code>',
             'Введите новое время объявления, например <code>15:00</code>.',
             'Enter a new time for renew, for example <code>15:00</code>')
insertPhrase('time_changed_successfully',
             '✅Ժամը հաջողությամբ փոխվեց ✅',
             '✅Время успешно изменено ✅',
             '✅Time changed successfully ✅')
insertPhrase('change_limit',
             'Մուտքագրեք նոր սահմանաչափ,0 նշանակում է թարմացնել հասանելի ամեն ինչ, օրինակ <code>50</code>',
             'Введите новый лимит, 0 означает обновление всего доступного, например <code>50</code>.',
             'Enter a new limit, 0 means renew everything available, for example <code>50</code>')
insertPhrase('limit_changed_successfully',
             '✅ Սահմանաչափը հաջողությամբ փոխվեց ✅',
             '✅ Лимит успешно изменен ✅',
             '✅ Limit changed successfully ✅')

# insertPhrase('aaa','aaa','aaa','aaa')
# insertPhrase('aaa','aaa','aaa','aaa')
