...
insertPhrase('renew_now','♻️Թարմացնել հիմա','♻️Обнови сейчас','♻️Renew now')
insertPhrase('renewd_n_items','♻️Թարմացվել է [nRenews] հայտարարություն♻️','♻️Обновлено [nRenews] объявлении♻️','♻️Updated [nRenews] listings♻️')
insertPhrase('cant_renew_for_30_mins',
             '❌ Այժմ չեք կարող թարմացնել ❗️ Կարող եք թարմացնել 30 րոպեն մեկ անգամ։',
